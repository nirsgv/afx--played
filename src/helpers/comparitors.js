...
const areFiltersApplied = (filteredByTags, filteredByPeriods, filteredBySearch) => {
    return filteredByTags.length || filteredByPeriods.length || filteredBySearch.length;
};
